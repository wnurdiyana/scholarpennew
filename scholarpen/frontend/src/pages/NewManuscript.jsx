...
const STEPS = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "keywords", label: "Candidate keywords", placeholder: "Comma-separated; ScholarPen will refine for WoS indexing.", textarea: false },
    ],
  },
  {
    id: "methods",
        ...
        <header className="border-b border-zinc-200 bg-white">
          <div className="max-w-5xl mx-auto px-8 py-8">
            ...
            <p className="mt-2 text-sm text-zinc-600 max-w-2xl">
              Capture your research foundation. ScholarPen will use these inputs as the source of truth when
